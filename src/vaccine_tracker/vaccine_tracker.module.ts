...
import {VaccineTracker, VaccineTrackerSchema} from "./schemas/vaccine_tracker.schema";

@Module({
  imports: [MongooseModule.forFeature([{ name: VaccineTracker.name, schema: VaccineTrackerSchema }])],
